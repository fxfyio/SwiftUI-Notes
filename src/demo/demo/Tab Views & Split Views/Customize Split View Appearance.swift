//
//  Customize Split View Appearance.swift
//  demo
//
...
struct Customize_Split_View_Appearance: View {
    ...
    var body: some View {
        NavigationSplitView(columnVisibility: $columnVisibility) {
            ...
            if let selectedMovie = selectedMovie {
                ...
                Text("Select a moview from the list to see its details")
            }
        }
...
struct Customize_Split_View_Appearance_Previews: PreviewProvider {
    static var previews: some View {
        Customize_Split_View_Appearance()
    }
}
